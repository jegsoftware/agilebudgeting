...
public class ActualItemTest {
    ...
    public void setUp() {
        ...
        testItem = ActualItem.createActualItem(period, "01/03/2017", "Test item", 42.00, "Checking", itemPersister);
    }
    ...
    public void createItemFromScratch() throws Exception {
        ...
        assertEquals("ActualItem", testItem.getType());
    ...
    public void addPlannedItem() throws Exception {
        PlannedItem relatedItem = PlannedItem.createItem(period, "Test description", 22.00, "Checking", itemPersister);
